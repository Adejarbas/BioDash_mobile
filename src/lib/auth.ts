...
// EXPO_PUBLIC_NEXT_API_URL deve incluir o sufixo /api, ex: http://44.196.163.18:3003/api
const API_URL = process.env.EXPO_PUBLIC_NEXT_API_URL || "http://44.196.163.18:3003/api";
